...
class agcrn(nn.Module):
    def __init__(self, device, num_nodes,  input_dim=1, rnn_units= 64, output_dim=1, horizon =12, cheb_k = 2, num_layers = 2 , embed_dim = 10,  default_graph = True ):
    ...
    def forward(self, source,  A_hat, edges, edge_weights, teacher_forcing_ratio=0.5):
        #source: B, T_1, N, D
        #target: B, T_2, N, D
        ...
        output = output.permute(0, 3, 1, 2)                             #B, N, T, C
        output = output.squeeze(3)
        #print("I am output shape of the model",output.shape)
